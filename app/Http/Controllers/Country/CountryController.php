...
class CountryController extends Controller
{
    ...
    public function item($slug_country,$slug_subcountry, $slug_subcountry__item)
    {
        ...
        settype($infos, "array");
            ...
            $resorts = (count($hot_category->resorts)) ? $hot_category->resorts()->first() : [];

            $excursions = (count($hot_category->excursions)) ? $hot_category->excursions()->first() : [];

            $hotels = (count($hot_category->hotels)) ? $hot_category->hotels()->first() : [];

            $infos = (count($hot_category->infos)) ? $hot_category->infos()->first() : [];
