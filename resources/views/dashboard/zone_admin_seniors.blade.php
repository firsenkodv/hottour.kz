            ...
            <div class="cabinet__flex  height_100">
                ...
                <div class="cabinet__right">
                    ...
                    <div class="cabinet_radius12_fff">
                        ...
                        <div class="c__title_subtitle">
                            <div class="c__title_subtitle_flex">
                                <div class="c__title_subtitle_left">
                                    <h3 class="F_h1">{{ __('Руководители отдела продаж') }}</h3>
                                    <div class="F_h2 pad_t5"><span>{{__('Полный список руководителей отдела продаж на сайте.')}}</span>
                                    </div>
                                </div>
                        ...
                        @include('dashboard.seniors.seniors')
                    </div>
