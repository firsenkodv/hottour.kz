        ...
        <div class="blockYourManeger__bottom">
            ...
            <div class="blockYourManeger__bottom_flex">
                <div class="blockYourManeger__bottom_left">
                    ...
                    <div class="blockYourManeger__bottom_numPhone">
                        <a href="tel:{{(isset($manager->connection->phone))?$manager->connection->phone:$manager->phone}}">{{(isset($manager->connection->phone))?format_phone($manager->connection->phone):format_phone($manager->phone)}}</a>
                    </div>

                </div>
                <div class="blockYourManeger__bottom_right">
                    @if(isset($manager->connection->whatsapp))
                    ...
                    @endif
                    @if(isset($manager->connection->telegram))
            ...
            <div class="blockYourManeger__bottom_flex">
                <div class="blockYourManeger__bottom_left">
                    ...
                    <div
                        class="blockYourManeger__bottom_numPhone">{{(isset($manager->connection->email))?$manager->connection->email:$manager->email}}</div>
                </div>
