        ...
        <div class="index_questions__flex">
            <div class="index_questions__left">
                ...
                <div class="l__addredd">
                    {!! config('site.setting.sityAddress') !!}
                </div>
                ...
                <div class="l__social">
                    <div class="s__1">
                        <a target="_blank" href="{!! config('site.setting.whatsapp') !!}">
                    ...
                    <div class="s__2">
                        <a target="_blank" href="{!! config('site.setting.telegram') !!}">
                    ...
                    <div class="s__3">
                        <a target="_blank" href="mailto:{!! config('site.setting.email') !!}">
